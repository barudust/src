        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div id="registro-adeudo">
                        <h2>Registrar Adeudo</h2>
                        <input type="text" id="descripcion" placeholder="Descripción del adeudo">
                        <input type="number" id="monto-adeudo" placeholder="Monto del adeudo">
                        <button onclick="registrarAdeudo()">Registrar Adeudo</button>
                        <p id="mensaje-registro-adeudo"></p>
                    </div>

                    <div id="modificar-adeudo">
                        <h2>Modificar Adeudo</h2>
                        <input type="number" id="id-modificar-adeudo" placeholder="ID del adeudo">
                        <input type="text" id="nuevo-descripcion" placeholder="Nueva descripción">
                        <input type="number" id="nuevo-monto-adeudo" placeholder="Nuevo monto">
                        <button onclick="modificarAdeudo()">Modificar Adeudo</button>
                        <p id="mensaje-modificacion-adeudo"></p>
                    </div>

                    <div id="eliminar-adeudo">
                        <h2>Eliminar Adeudo</h2>
                        <input type="number" id="id-eliminar-adeudo" placeholder="ID del adeudo a eliminar">
                        <button onclick="eliminarAdeudo()">Eliminar Adeudo</button>
                        <p id="mensaje-eliminacion-adeudo"></p>
                    </div>

                    <div id="visualizar-adeudos">
                        <h2>Visualizar Adeudos</h2>
                        <button onclick="visualizarAdeudos()">Ver Adeudos</button>
                        <ul id="lista-adeudos"></ul>
                    </div>
                </div>
        </main>
